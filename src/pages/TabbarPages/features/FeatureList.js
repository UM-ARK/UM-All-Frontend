...
export const getFunctionArr = (t) => [
    {
        ...
        fn: [
            ...
            },
            {
                ...
                fn_name: t('私信', { ns: 'features' }),
                needLogin: true,
                go_where: 'HarborChatList',
                loginRoute: 'HarborChatList',
                describe: t('登入 Harbor 後查看私信對話、未讀消息，或搜尋其他使用者開始聊天', { ns: 'features' }),
                key_name: '私信',
                keywords: 'Harbor, Direct Message, Private Message, DM, Chat, Inbox, Conversation, 私信, 私訊, 消息, 聊天, 對話, 收件箱, 未讀',
            },
            {
                icon_type: iconTypes.materialCommunityIcons,
    ...
    },
    {
        ...
        fn: [
            ...
            },
            {
                ...
                fn_name: t('共享組隊', { ns: 'features' }),
                needLogin: true,
                go_where: 'MyTabbar',
                describe: t('登入後前往「我的」，建立或加入組隊、分享邀請、填寫空閒時間及選擇共享課表', { ns: 'features' }),
                key_name: '共享組隊',
                keywords: 'Team Schedule, Shared Timetable, Collaboration, Group, Invite, Availability, Meeting, 組隊, 協作, 共享, 課表, 邀請, 空閒時間, 約時間, 小組',
            },
        ],
    },
    {
